...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"D:/DS-Project/Data-Science-AI-ML-DL/.venv/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/b/abs_b0lpi9pj9c/croot/contourpy_1738161183484/work/.mesonpy-qqb9u0ub/build/lib/contourpy/util",
        source_dir=r"C:/b/abs_b0lpi9pj9c/croot/contourpy_1738161183484/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/b/abs_b0lpi9pj9c/croot/contourpy_1738161183484/work/.mesonpy-qqb9u0ub/build/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
